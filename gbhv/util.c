...
unsigned __int64 HvUtilVmRead(unsigned __int64 vmcs_field)
{
...
void HvUtilVmWrite(unsigned __int64 vmcs_field, unsigned __int64 value)
{
	__vmx_vmwrite(vmcs_field, value);
}